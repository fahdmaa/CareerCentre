...
export default function EventsPage() {
  ...
  const handleEventClick = (event: Event) => {
    ...
    console.log('Setting selectedEvent and showDetailsModal to true')
  ...
  console.log('Render: loading:', loading, 'events:', events.length, 'filtered:', filteredEvents.length, 'showDetailsModal:', showDetailsModal)
